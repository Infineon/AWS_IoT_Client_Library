...
#define AWS_DEFAULT_INTERFACE                 (WICED_STA_INTERFACE)
...
typedef struct
{
    ...
    linked_list_t                               connections;            /**< A linked-list to store all Connection endpoints( @ref wiced_aws_greengrass_core_connection_t ) available for this core.For example: A core can have multiple network Interfaces. */
 ...
 ******************************************************/
wiced_result_t json_callback_for_discovery_payload (wiced_json_object_t* json_object );
